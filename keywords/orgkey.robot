...
Resource  D:/robotframework/variables/orgvar.robot
...
jobtitle dropdown
    FOR  ${i}  IN RANGE  1  20
        ...
        ${element2} =  Run Keyword And Return Status  Element should be Visible  ${netadm}
        IF    ${element2}
            Wait Until Element Is Visible  ${netadm}
            Press Keys  ${netadm}  ENTER
            Exit For Loop
        ELSE
            Log  continue
        END    
